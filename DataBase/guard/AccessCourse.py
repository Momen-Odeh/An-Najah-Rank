...
def accessCourse(courseNumber, universityNumber):
    query = f"""
                        ...
                        UNION
                        SELECT studentNumber as registerNumber FROM `an-najah rank`.student_enrollments WHERE courseNumber={courseNumber};
                        UNION
